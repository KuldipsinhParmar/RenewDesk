...
(function () {
    ...
    var ICONS = {
        ...
        invoices:    '<path d="M6 2h9l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"/><path d="M15 2v5h5"/><path d="M8 12h8M8 16h5"/>',
    ...
    function buildHTML(active) {
        ...
        return [
            ...
            '<nav class="rd-nav">',
              ...
              navLink('invoices',     'invoices.html',     'Invoices',    active),
              navLink('reports',      'reports.html',      'Reports',     active),
              navLink('analytics',    'analytics.html',    'Analytics',   active),
